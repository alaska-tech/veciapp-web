...
export interface BuyingOrder extends BaseAttributes {
  id: string;
  vendorId: string;
  branchId: string;
  customerId: string;
...
export interface Conciliation extends BaseAttributes {
  id: string;
  buyingOrderId: string;
  status: "created" | "read" | "discarded" | "resolved";
  origin:
    | "autogenerated_by_vendor_cancel"
    | "autogenerated_by_customer_cancel"
    | "issued_by_vendor"
    | "issued_by_customer";
  chatId: string;
}
...
export interface ServiceOrder extends BaseAttributes {
  ...
  productsSnapshots: Array<ProductService>;
  subtotal: number;
  taxAmmount: number;
...
export type entityTypeOptionsType = typeof entityTypeOptions;
...
export type ChangeRequestStatusOptionsType = typeof ChangeRequestStatusOptions;
export interface ChangeRequest extends BaseAttributes {
  id: string;
  vendorId: string;
  requestedChanges: {
  ...
  entityType: entityTypeOptionsType[number];
  entityId: string;
