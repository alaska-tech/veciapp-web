...
const VENDOR_EDITABLE_FIELDS = ['name', 'RUT', 'email', 'phone', 'legalRepresentative', 'bankAccount']
const BRANCH_EDITABLE_FIELDS = ['name', 'address', 'phone', 'operatingHours', 'description', 'managerName', 'managerPhone']
