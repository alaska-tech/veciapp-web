...
const PRODUCT_TYPE_TAG: Record<string, any> = {
  product: <Tag bordered={false} color="geekblue">Producto</Tag>,
  service: <Tag bordered={false} color="magenta">Servicio</Tag>
}
const Users = () => {
  ...
  const columns: TableColumnsType<DataType> = [
    {
      ...
      render(value, record, index) {
        ...
        return <Space wrap>{typeTag}{value}<Tag>{record.categoryId}</Tag></Space>
      },
    }, {
      title: "Imagen",
      key: "mainImage",
      ...
      render(value, record, index) {
        ...
        ><Image src={value}
          ...
          width={75} height={75}></Image></Image.PreviewGroup>
      },
    }, {
      title: "Precio",
      key: "finalPrice",
      ...
      dataIndex: "state",
      render(value, record, index) {
        return <Tag color={record.state === "unavailable" ? "default" : "blue"}>{value}</Tag>
      },
    },
    {
      title: "Action",
